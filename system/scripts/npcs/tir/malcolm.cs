...
public class MalcolmsShop : NpcShopScript
{
    public override void Setup()
    {
        Add("General Goods", 40093);      // Pet Instructor Stick
        Add("General Goods", 61000);      // Score Scroll
        Add("General Goods", 61000);      // Score Scroll
        Add("General Goods", 61000);      // Score Scroll
        Add("General Goods", 61000);      // Score Scroll
        Add("General Goods", 61000);      // Score Scroll
        Add("General Goods", 61500, 10);  // Paper x10
        Add("General Goods", 61500, 100); // paper x100
        ...
        Add("General Goods", 41086);      // Lute
        Add("General Goods", 41086);      // Lute
        Add("General Goods", 19002);      // Slender Robe
        Add("General Goods", 50078);      // Ticking Quiz Bomb
        Add("General Goods", 41086);      // Lute
        Add("General Goods", 19002);      // Slender Robe
        Add("General Goods", 19002);      // Slender Robe
        ...
        Add("Hats", 18023);               // Mongo's Theif Cap
        ...
        Add("Shoes & Gloves", 40092);     // Pet Instructor Glove
